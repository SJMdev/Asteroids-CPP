 ...
 ***********************************/
void Path::setMag(double speed)
{
   double angleRadians = deg2rad(getAngle());
 ...
 *********************************/
void Path::setAngle(double angleDegrees)
{
   double angleRadians = deg2rad(angleDegrees);
   double speed = getMag();
   dx = -cos(angleRadians) * speed;
   dy = -sin(angleRadians) * speed;
}
 ...
 **************************************/
void Path::setVelocity(double angleDegrees, double speed)
{
   double angleRadians = deg2rad(angleDegrees);
   dx = -cos(angleRadians) * speed;
   dy = -sin(angleRadians) * speed;
 ...
 *************************************/
double Path::operator - (const Path & vRhs) const
{
   ...
   dMax = MAX(dMax, (double)0.1); // when dx and dy are 0.0. Go through the loop once.
